...
// import { getOrder,getPlace } from '../redux/apiCalls';
...
const getReg = async(search,
    ...
    setLoading(true)
    try {
        const res = await authFetch.get(`modification/birth-attestation/list-by-state?search=${search}&result_per_page=${resPage}&page=${page}&StateID=${stateID}`);
...
<Dropdown value={stateID} options={states && states} onChange={(e) => setStateID(e.value)} placeholder="Select Sex" optionValue='State_ID' optionLabel='State_Name'/>
  ...
  return (
    ...
    <div className='grid mt-2'>
     <div className="col-12 lg:col-12">
        ...
        <span className="text-xl font-medium text-900">Modified Attestation Registration List</span>
