...
const getReg = async(search,
    ...
    setLoading(true)
    try {
        const res = await authFetch.get(`modification/death-registration/list-by-state?search=${search}&result_per_page=${resPage}&page=${page}&StateID=${stateID}`);
  ...
  return (
    ...
    <div className='grid mt-2'>
     <div className="col-12 lg:col-12">
        ...
        <span className="text-xl font-medium text-900">Modified Death Registration List</span>
             ...
             ref={dt}
                    ...
                    //  currentPageReportTemplate="Showing {first} to {last} of {totalRecords}" rows={5} rowsPerPageOptions={[5,10,50]}
                        ...
                        {/* <Column field="id" header="Device Id"></Column> */}
                            ...
                            <Column field="deceased_firstname" header="deceased_firstname"></Column>
