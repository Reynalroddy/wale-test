...
import { getStillCenters } from '../redux/apiCalls';
...
<h4>Still birth Registrations by Center's</h4>
...
<Link to={`/still/list?center=${it.registration_center}`}>
