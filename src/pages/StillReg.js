...
import { getStillZones } from '../redux/apiCalls';
...
<h4>Still birth Registrations by Geo-political zone</h4>
...
<Link to={`/still/state/${it.Geo_Zone_id}`}>
